...
**Current Version:** `1.0.0-rc1` — Phase 18 Complete
...
| [AI Kernel](../architecture/ai-kernel.md) | Central intelligence engine |
| [Orchestrator](../architecture/orchestrator.md) | Task coordination layer |
| [Multi-Agent](../architecture/multi-agent.md) | Multi-agent framework |
| [LLM Pool](../architecture/llm-pool.md) | LLM provider management |
| [Memory](../architecture/memory.md) | Memory subsystem |
| [RAG](../architecture/rag.md) | Retrieval-augmented generation |
| [MCP](../architecture/mcp.md) | Model Context Protocol |
| [Automation](../architecture/automation.md) | Automation engine |
